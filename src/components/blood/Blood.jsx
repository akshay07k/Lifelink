...
function Blood() {
  return (
    ...
    <header className="bg-red-500 text-white text-center py-8">
        ...
        <a href="#donate" className="mt-4 inline-block px-6 py-2 bg-white text-red-500 rounded-full font-semibold hover:bg-red-100 transition duration-300">
            Donate Now
        </a>
    </header>
    ...
    <section id="process1" className="bg-white p-8 flex h-80">
      <div className="w-1/2 h-full pt-16 px-8">
          ...
          <button className="bg-red-500 text-white text-lg px-5 py-2.5 rounded-full hover:bg-red-600 transition duration-300">
              Request Blood
          </button>
      </div>
